...
**📌 Скриншот с процессом перетаскивания карточки**  
*(сюда можно вставить изображение с перемещением кандидата между колонками)*  
...
**📌 Скриншот с несколькими карточками в разных колонках**  
*(здесь можно вставить изображение с заполненными карточками в разных колонках)*  
...
**📌 Скриншот открытой карточки кандидата**  
*(сюда можно вставить изображение с детальной информацией о кандидате в карточке)*  
